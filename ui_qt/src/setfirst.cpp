...
static int old_recordTime=recordTime;
...
extern int cameraHeight,cameraWidth;
...
void SetFirst::on_movieTimeSetting_valueChanged(int value)
{
    ...
    recordTime=value;
#if defined(os_test)
    config_set_cyctime(0,recordTime);
#endif
}
