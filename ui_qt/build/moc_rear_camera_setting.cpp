...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Rear_Camera_Setting_t, stringdata) + ofs \
...
void Rear_Camera_Setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Rear_Camera_Setting *_t = static_cast<Rear_Camera_Setting *>(_o);
        switch (_id) {
...
const QMetaObject Rear_Camera_Setting::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Rear_Camera_Setting.data,
      qt_meta_data_Rear_Camera_Setting,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Rear_Camera_Setting::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Rear_Camera_Setting.stringdata))
        return static_cast<void*>(const_cast< Rear_Camera_Setting*>(this));
