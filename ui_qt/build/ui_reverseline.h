...
public:
    ...
    void setupUi(QDialog *ReverseLine)
    {
        if (ReverseLine->objectName().isEmpty())
            ReverseLine->setObjectName(QStringLiteral("ReverseLine"));
...
"background-color:rgb(255,255,255,0);"));
    ...
    {
        ReverseLine->setWindowTitle(QApplication::translate("ReverseLine", "Dialog", 0));
        groupBox_2->setTitle(QString());
        groupBox->setTitle(QString());
        label->setText(QApplication::translate("ReverseLine", "\345\200\222\350\275\246\345\220\216\350\247\206\351\242\204\350\247\210", 0));
        label_2->setText(QApplication::translate("ReverseLine", "\345\200\222\350\275\246\347\272\277\350\256\276\347\275\256", 0));
    } // retranslateUi
