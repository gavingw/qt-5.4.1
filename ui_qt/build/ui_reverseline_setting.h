...
public:
    ...
    void setupUi(QDialog *ReverseLine_Setting)
    {
        if (ReverseLine_Setting->objectName().isEmpty())
            ReverseLine_Setting->setObjectName(QStringLiteral("ReverseLine_Setting"));
        ReverseLine_Setting->resize(1018, 550);
        ReverseLine_Setting->setStyleSheet(QStringLiteral("background-color:rgb(255,255,255,0);"));
        gridLayout = new QGridLayout(ReverseLine_Setting);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        widget_3 = new QWidget(ReverseLine_Setting);
        widget_3->setObjectName(QStringLiteral("widget_3"));
        widget_3->setStyleSheet(QLatin1String("border-radius:10px;\n"
"background-color:rgba(167, 167, 167,40);"));
        ...
        pushButton_2->setStyleSheet(QLatin1String("border-image:url(\":/icon/navigate-up.png\");\n"
"border-radius:0px;"));
        ...
        pushButton_3->setStyleSheet(QLatin1String("border-image:url(\":/icon/navigate-down.png\");\n"
"border-radius:0px;"));
        ...
        pushButton_4->setStyleSheet(QLatin1String("border-image:url(:/icon/Save.png);\n"
"border-radius:0px;"));
    ...
    {
        ReverseLine_Setting->setWindowTitle(QApplication::translate("ReverseLine_Setting", "Dialog", 0));
