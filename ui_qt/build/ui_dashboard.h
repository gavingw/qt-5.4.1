...
public:
    ...
    void setupUi(QDialog *dashBoard)
    {
        ...
        GPSButton->setStyleSheet(QStringLiteral("background-color:rgb(177, 255, 8)"));
        ...
        bdButton->setStyleSheet(QStringLiteral("background-color:rgb(49, 138, 255)"));
        ...
        scrollArea_3->setStyleSheet(QStringLiteral("background-image:url(:/GPS.png)"));
        ...
        scrollArea_2->setStyleSheet(QStringLiteral("background-image:url(:/GPS.png)"));
        ...
        pushButton->setStyleSheet(QStringLiteral("border-image:url(:/icon/Back.png)"));
        ...
        label->setStyleSheet(QStringLiteral("color:rgb(255, 69, 7)"));
        ...
        label_2->setStyleSheet(QStringLiteral("color: rgb(121, 255, 32);"));
        ...
        label_3->setStyleSheet(QStringLiteral("color:rgb(129, 255, 11)"));
    ...
    {
        dashBoard->setWindowTitle(QApplication::translate("dashBoard", "Dialog", 0));
        GPSButton->setText(QApplication::translate("dashBoard", "GPS", 0));
        bdButton->setText(QApplication::translate("dashBoard", "\345\214\227\346\226\227", 0));
        pushButton->setText(QString());
        label->setText(QApplication::translate("dashBoard", "GPS\345\267\262\350\277\236\346\216\245", 0));
        label_2->setText(QApplication::translate("dashBoard", "\345\215\253\346\230\237\344\277\241\345\217\267\346\257\224>40", 0));
        label_3->setText(QApplication::translate("dashBoard", " \347\273\217\347\272\254\345\272\246\357\274\232", 0));
    } // retranslateUi
