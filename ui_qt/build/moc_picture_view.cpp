...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Picture_view_t, stringdata) + ofs \
...
void Picture_view::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Picture_view *_t = static_cast<Picture_view *>(_o);
        switch (_id) {
...
const QMetaObject Picture_view::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Picture_view.data,
      qt_meta_data_Picture_view,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Picture_view::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Picture_view.stringdata))
        return static_cast<void*>(const_cast< Picture_view*>(this));
