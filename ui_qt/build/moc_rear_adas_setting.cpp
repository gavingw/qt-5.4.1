...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_rear_ADAS_setting_t, stringdata) + ofs \
...
void rear_ADAS_setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        rear_ADAS_setting *_t = static_cast<rear_ADAS_setting *>(_o);
        switch (_id) {
...
const QMetaObject rear_ADAS_setting::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rear_ADAS_setting.data,
      qt_meta_data_rear_ADAS_setting,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *rear_ADAS_setting::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rear_ADAS_setting.stringdata))
        return static_cast<void*>(const_cast< rear_ADAS_setting*>(this));
