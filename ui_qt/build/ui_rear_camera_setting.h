...
public:
    ...
    void setupUi(QDialog *Rear_Camera_Setting)
    {
        if (Rear_Camera_Setting->objectName().isEmpty())
            Rear_Camera_Setting->setObjectName(QStringLiteral("Rear_Camera_Setting"));
        ...
        pushButton->setStyleSheet(QLatin1String("background-color:rgb(47, 207, 255);\n"
...
"}"));
    ...
    {
        Rear_Camera_Setting->setWindowTitle(QApplication::translate("Rear_Camera_Setting", "Dialog", 0));
        pushButton->setText(QApplication::translate("Rear_Camera_Setting", "\345\220\216\346\221\204\345\203\217\345\244\264\350\256\276\347\275\256", 0));
        upperButton->setText(QString());
        downButton->setText(QString());
        returnButton->setText(QString());
        sureButton->setText(QApplication::translate("Rear_Camera_Setting", "next", 0));
    } // retranslateUi
