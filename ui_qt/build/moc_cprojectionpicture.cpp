...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CProjectionPicture_t, stringdata) + ofs \
...
void CProjectionPicture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CProjectionPicture *_t = static_cast<CProjectionPicture *>(_o);
        switch (_id) {
...
const QMetaObject CProjectionPicture::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CProjectionPicture.data,
      qt_meta_data_CProjectionPicture,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CProjectionPicture::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CProjectionPicture.stringdata))
        return static_cast<void*>(const_cast< CProjectionPicture*>(this));
