...
public:
    ...
    void setupUi(QDialog *Picture_view)
    {
        if (Picture_view->objectName().isEmpty())
            Picture_view->setObjectName(QStringLiteral("Picture_view"));
...
"}"));
        ...
        widget->setStyleSheet(QStringLiteral("background-color:rgb(58, 58, 58,100);"));
...
"background-color:rgb(255,255,255,0);"));
        ...
        smallerButton->setStyleSheet(QLatin1String("border-image:url(:/icon/smaller.png);\n"
"background-color:rgb(255,255,255,0);"));
        ...
        nextPicButton->setStyleSheet(QLatin1String("border-image:url(:/icon/next.png);\n"
"background-color:rgb(255,255,255,0);"));
    ...
    {
        Picture_view->setWindowTitle(QApplication::translate("Picture_view", "Dialog", 0));
        lab_Ico->setText(QString());
        label->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Min->setToolTip(QApplication::translate("Picture_view", "\346\234\200\345\260\217\345\214\226", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Min->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Max->setToolTip(QApplication::translate("Picture_view", "\346\234\200\345\244\247\345\214\226", 0));
#endif // QT_NO_TOOLTIP
        btnMenu_Max->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnMenu_Close->setToolTip(QApplication::translate("Picture_view", "\345\205\263\351\227\255", 0));
#endif // QT_NO_TOOLTIP
