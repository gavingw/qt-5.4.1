...
#define NB_COMPOSE_BUFFER 10

#define USE1_Deinterlace_HW
...
private:
	...
	bool canCompose();
	void composeBuffer(unsigned char *outBuffer,unsigned char *inBuffer0,unsigned char *inBuffer1,
