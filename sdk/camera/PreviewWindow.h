...
public:
    ...
    PreviewWindow();
	struct ScMemOpsS* mPreviewMemops;
...
protected:
	//unsigned int mPreviewAddrVir;
	//unsigned int mPreviewAddrPhy;
     ...
     */
    bool adjustPreviewDimensions(V4L2BUF_t* pbuf,bool isOview);
...
private:
	tr_obj  imgtr;
	//bool setSrcFormat(struct src_info *src, libhwclayerpara_t *pic, V4L2BUF_t *pv4l2_buf, int index);
};
